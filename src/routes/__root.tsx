...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Master in-demand skills with expert-led courses on development, design, AI, business, and marketing." },
      { property: "og:title", content: "LearnForge — Learn Without Limits" },
      { property: "og:description", content: "Master in-demand skills with expert-led courses." },
