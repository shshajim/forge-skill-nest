...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "LearnForge — Learn Without Limits" },
      { name: "twitter:description", content: "Master in-demand skills with expert-led courses. 10,000+ students, 4.8 avg rating, 200+ courses." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/98be43b1-36b1-481a-a767-c9e3d733eea7/id-preview-1aed8566--e7fd9f73-15aa-4439-a4cc-cd2f952e48fb.lovable.app-1783451266794.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/98be43b1-36b1-481a-a767-c9e3d733eea7/id-preview-1aed8566--e7fd9f73-15aa-4439-a4cc-cd2f952e48fb.lovable.app-1783451266794.png" },
    ],
